export const RealUnitShares = [
  ...
  {
    inputs: [{ internalType: "address", name: "lostAddress", type: "address" }],
    name: "deleteClaim",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "recovery",
    outputs: [
      { internalType: "contract IRecoveryHub", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "string", name: "_terms", type: "string" }],
    name: "setTerms",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newTotalShares", type: "uint256" },
    ],
    name: "setTotalShares",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "account", type: "address" },
      { internalType: "uint8", name: "typeNumber", type: "uint8" },
    ],
    name: "setType",
    outputs: [],
    stateMutability: "nonpayable",
